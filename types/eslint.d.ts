declare module "eslint" {
    ...
    namespace AST {
        export type NodeLike = Comment | Node | Token;
    ...
    namespace Rule {
        ...
        interface NodeListener {
            ...
            AssignmentPattern?:
                | ((
                      node: ESTree.AssignmentPattern & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            BinaryExpression?:
                | ((
                      node: ESTree.BinaryExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            ClassDeclaration?:
                | ((
                      node: ESTree.ClassDeclaration & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            ContinueStatement?:
                | ((
                      node: ESTree.ContinueStatement & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            DebuggerStatement?:
                | ((
                      node: ESTree.DebuggerStatement & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            DoWhileStatement?:
                | ((
                      node: ESTree.DoWhileStatement & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            ExpressionStatement?:
                | ((
                      node: ESTree.ExpressionStatement & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            FunctionDeclaration?:
                | ((
                      node: ESTree.FunctionDeclaration & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            FunctionExpression?:
                | ((
                      node: ESTree.FunctionExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            ImportDeclaration?:
                | ((
                      node: ESTree.ImportDeclaration & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            ImportExpression?:
                | ((
                      node: ESTree.ImportExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            LabeledStatement?:
                | ((
                      node: ESTree.LabeledStatement & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            LogicalExpression?:
                | ((
                      node: ESTree.LogicalExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            MemberExpression?:
                | ((
                      node: ESTree.MemberExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            MethodDefinition?:
                | ((
                      node: ESTree.MethodDefinition & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            ObjectExpression?:
                | ((
                      node: ESTree.ObjectExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            PrivateIdentifier?:
                | ((
                      node: ESTree.PrivateIdentifier & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            PropertyDefinition?:
                | ((
                      node: ESTree.PropertyDefinition & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            SequenceExpression?:
                | ((
                      node: ESTree.SequenceExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            UpdateExpression?:
                | ((
                      node: ESTree.UpdateExpression & NodeParentExtension
                  ) => void)
                | undefined;
            ...
            VariableDeclaration?:
                | ((
                      node: ESTree.VariableDeclaration & NodeParentExtension
                  ) => void)
                | undefined;
        ...
        type ReportDescriptorLocation =
            | { node: ESTree.Comment | ESTree.Node }
    ...
    namespace Linter {
        ...
        > extends HasRules<Rules> {
             ...
             */
            globals?: { [name: string]: GlobalConf } | undefined;
        ...
        type ProcessorPostprocess = (
            messages: LintMessage[][],
            filename: string
        ) => LintMessage[];

        type ProcessorPreprocess = (text: string, filename: string) => T[];
        ...
        > extends ESLint.ObjectMetaProperties {
            ...
            preprocess?: ProcessorPreprocess;
            postprocess?: ProcessorPostprocess;
        }
    ...
    namespace ESLint {
        type ConfigData<Rules extends Linter.RulesRecord = Linter.RulesRecord> =
            Omit<Linter.Config<Rules>, "$schema">;
        ...
        interface Plugin {
            configs?:
                | Record<
                      string,
                      ConfigData | Linter.FlatConfig | Linter.FlatConfig[]
                  >
                | undefined;
            environments?: Record<string, Environment> | undefined;
            parsers?: Record<string, Linter.Parser> | undefined;
        ...
        interface ESLintOptions {
             ...
             */
            baseConfig?: Linter.Config | Linter.FlatConfig | undefined;
            ...
            /**
             * The value ot use for the current working directory.
             */
            cwd?: string | undefined;
            ...
            /**
             * et to false to skip glob resolution of input file paths to lint (default: true). If false, each input file paths is assumed to be a non-glob path to an existing file.
             */
        ...
        interface FormatterContext {
            cwd: string;
            maxWarningsExceeded?: MaxWarningsExceeded;
            rulesMeta: Record<string, RuleMetaData>;
        }

        /**
         * A formatter function.
         * @param results The list of linting results.
