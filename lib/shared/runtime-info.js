...
function environment() {
     ...
     * @param {string[]} args The arguments to be executed with the command.
     ...
     * @typedef {Object} GetNpmPackageVersionOptions
     * @property {boolean} [global] Whether to check globally.
     */

    /**
     * Gets installed npm package version.
     * @param {string} pkg The package to check.
     * @param {GetNpmPackageVersionOptions} options Options to get the package version.
     * @throws {Error} As may be collected by `cross-spawn.sync`.
     * @returns {string} The normalized version returned by the command.
     */
