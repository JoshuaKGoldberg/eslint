...
/** @typedef {import("@humanwhocodes/config-array").ConfigArray} ConfigArray */
/** @typedef {import("@humanwhocodes/config-array").ExtractedConfig} ExtractedConfig */
/** @typedef {import("eslint-visitor-keys").VisitorKeys} VisitorKeys */
/** @typedef {import("estree").Comment} Comment */
/** @typedef {import("eslint").ESLint.ConfigData} ConfigData */
/** @typedef {import("eslint").ESLint.Environment} Environment */
/** @typedef {import("eslint").Linter.GlobalConf} GlobalConf */
...
/** @typedef {import("eslint").Linter.ProcessorPostprocess} ProcessorPostprocess */
/** @typedef {import("eslint").Linter.ProcessorPreprocess} ProcessorPreprocess */
/** @typedef {import("eslint").Linter.Severity} Severity */
/** @typedef {import("eslint").Linter.SuppressedLintMessage} SuppressedLintMessage */
...
/**
 * @typedef {Object} DirectiveCommentParent
 * @property {Comment} commentToken Comment containing the directive.
 * @property {string[]} ruleIds Rules referenced by the directive.
 */
 ...
 * @property {DirectiveCommentParent | undefined} parentComment Comment containing this directive.
 ...
 * @property {Map<string, ParserModule>} parserMap The loaded parsers.
 ...
 * @property {ProcessorPostprocess} [postprocess] postprocessor for report
 *      messages. If provided, this should accept an array of the message lists
 *      for each code block returned from the preprocessor, apply a mapping to
 *      the messages as appropriate, and return a one-dimensional array of
 *      messages.
 * @property {ProcessorPreprocess} [preprocess] preprocessor for source text.
 ...
 * @param {Severity} [options.severity] the error message to report
...
/**
 * @typedef {Object} CreatedDisableDirectives
 * @property {DisableDirective[]} directives Array of directives.
 * @property {LintMessage[]} directiveProblems Lint messages caused by the directives.
 */
 ...
 * @param {Comment} options.commentToken The Comment token
 * @param {string} options.value The value after the directive in the comment
 * comment specified no specific rules, so it applies to all rules (e.g. `eslint-disable`)
 * @param {string} options.justification The justification of the directive
 * @param {function(string): {create: Function}} options.ruleMapper A map from rule IDs to defined rules
 * @returns {CreatedDisableDirectives} Directives and problems from the comment
 */
function createDisableDirectives(options) {
    ...
    /** @type {CreatedDisableDirectives} */
    const result = {
        directives: [], // valid disable directives
        directiveProblems: [] // problems in directives
    };

    /** @type {DirectiveCommentParent} */
 ...
 * @param {ParserModule} parser The parser which uses this options.
 ...
 * @param {ParserModule} config.parser The parser to use.
 ...
 * @param {import("eslint").AST.Node} ast The `Program` node to analyze.
 * @param {LanguageOptions} languageOptions The parser options.
 * @param {VisitorKeys} visitorKeys The visitor keys.
 * @returns {eslintScope.ScopeManager} The analysis result.
 */
function analyzeScope(ast, languageOptions, visitorKeys) {
    ...
    return eslintScope.analyze(ast, {
        ...
        // @types/eslint-scope declares this as "script" | "module"
        sourceType: /** @type {"script" | "module"} */(languageOptions.sourceType) || "script",
 ...
 * @param {RuleModule} rule A normalized rule with a `create` method
 ...
 * @param {function(string): RuleModule} ruleMapper A mapper function from rule names to rules
 ...
 * @returns {RuleModule|null} The rule.
 */
...
class Linter {
     ...
     * @param {Function | RuleModule} ruleModule Function from context to object mapping AST node types to event handlers
     * @returns {void}
     */
     ...
     * @param {Record<string, Function | RuleModule>} rulesToDefine map from unique rule identifier to rule
     * @returns {void}
     */
     ...
     * @returns {Map<string, RuleModule>} All loaded rules
     */
    getRules() {
        assertEslintrcConfig(this);
     ...
     * @param {ParserModule} parserModule The parser object
     * @returns {void}
     */
