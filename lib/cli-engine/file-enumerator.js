...
/** @typedef {import("@eslint/eslintrc").Legacy.CascadingConfigArrayFactory} LegacyConfigArrayFactory */
 ...
 * @property {LegacyConfigArrayFactory} [configArrayFactory] The factory for config arrays.
 * @property {string} [cwd] The base directory to start lookup.
 * @property {string[]} [extensions] The extensions to match files for directory patterns.
 * @property {boolean} [globInputPaths] Set to false to skip glob resolution of input file paths to lint (default: true). If false, each input file paths is assumed to be a non-glob path to an existing file.
 * @property {boolean} [ignore] The flag to check ignored files.
 * @property {boolean} [errorOnUnmatchedPattern] Whether to error when pattern is unmatched.
...
class FileEnumerator {
    ...
    *iterateFiles(patternOrPatterns) {
     ...
     * @returns {Generator<FileEntry> | FileEntry[]} The found files.
     */
     ...
     * @returns {FileEntry[]} The found files.
     * @private
     */
     ...
     * @returns {Generator<FileEntry>} The found files.
     * @private
     */
