...
/** @typedef {import("../config/flat-config-array").FlatConfigArray} FlatConfigArray */

/**
 * Validates that the given AST has the required information.
 * @param {Program} ast The Program node of the AST to check.
 ...
 * @returns {Record<string, boolean>} The globals for the given ecmaVersion.
 */
 ...
 * @param {import("eslint").AST.Node} astNode An AST node.
 ...
 * @param {import("eslint").AST.Node | Token} first The first node or token to check.
 * @param {import("eslint").AST.Node | Token} second The second node or token to check.
 ...
 * @param {import("eslint").AST.Node | Token} first The first node or token to check between.
 * @param {import("eslint").AST.Node | Token} second The second node or token to check between.
 ...
 * scope.
 * @param {eslintScope.Scope} globalScope The global scope.
...
/**
 * @typedef {Object} SourceCodeConfig
 * @property {string} text The source code text.
 * @property {import("eslint").AST.Node} ast The Program node of the AST representing the code. This AST should be created from the text that BOM was stripped.
 * @property {Object|null} parserServices The parser services.
 * @property {eslintScope.ScopeManager|null} scopeManager The scope of this source code.
 * @property {VisitorKeys|null} visitorKeys The visitor keys to traverse AST.
 */
...
class SourceCode extends TokenStore {
    ...
    /**
     * @param {string|SourceCodeConfig} textOrConfig The source code text or config object.
     * @param {import("eslint").AST.Node} [astIfNoConfig] The Program node of the AST representing the code. This AST should be created from the text that BOM was stripped.
     */
     ...
     * @param {import("eslint").AST.Node} [node] The AST node to get the text for.
     ...
     * @returns {import("eslint").AST.Node[]} An array of comment nodes.
     * @public
     */
    getAllComments() {
     ...
     * @param {import("eslint").AST.Node} node The AST node to get the comment for.
    ...
    getJSDocComment(node) {
         ...
         * @param {import("eslint").AST.Node} astNode The AST node to get the comment for.
         * @returns {Token|null} The Block comment token containing the JSDoc comment
         *      for the given node or null if not found.
         * @private
         */
     ...
     * @returns {import("eslint").AST.Node} The node if found or null if not found.
     * @public
     */
     ...
     * @param {import("eslint").AST.Node} currentNode The node to get the scope of
     * @returns {eslintScope.Scope} The scope information for this node
     ...
     * @param {import("eslint").AST.Node} node The node for which the variables are obtained.
     ...
     * @returns {Array<import("eslint").AST.Node>} All the ancestor nodes in the AST, not including the provided node, starting
     ...
     * @param {import("eslint").AST.Node} [refNode] The closest node to the variable reference.
     ...
     * @returns {{problems:Array<Problem>,configs:{config:FlatConfigArray,node:import("eslint").AST.Node}}} Information
