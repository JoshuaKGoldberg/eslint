 ...
 * @param {import("eslint").AST.Node} regexNode AST node which contains the regular expression.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {string} pattern The regular expression pattern to be checked.
         * @param {import("eslint").AST.Node} node AST node which contains the regular expression or a call/new expression.
         * @param {import("eslint").AST.Node} regexNode AST node which contains the regular expression.
