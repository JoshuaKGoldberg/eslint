 ...
 * @param {import("eslint").AST.Node} node An UnaryExpression node to check.
 ...
 * @param {import("eslint").AST.Node} node The node to test
 ...
 * @returns {import("eslint").AST.Node | null} The first non-numeric item in the BinaryExpression tree or null
 */
 ...
 * @param {import("eslint").AST.Node} node node that represents the expression to check.
 ...
 * @param {import("eslint").AST.Node} node A BinaryExpression node to check.
 ...
 * @param {import("eslint").AST.Node} node An AssignmentExpression node to check.
 ...
 * @param {import("eslint").AST.Node} node The flagged BinaryExpression node to check.
 * @returns {import("eslint").AST.Node} The operand that is not an empty string from a flagged BinaryExpression.
 */
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node An ast node to report the error on.
