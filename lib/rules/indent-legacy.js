...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node Node violating the indent rule
         ...
         * @param {import("eslint").AST.Node | Token} node Node to examine
         ...
         * @param {import("eslint").AST.Node[]} nodes list of node objects
         ...
         * @param {import("eslint").AST.Node} node Node to examine
         ...
         * @returns {import("eslint").AST.Node | void} if found then node otherwise null
         */
         ...
         * @param {import("eslint").AST.Node} node node to check
         * @param {import("eslint").AST.Node} varNode variable declaration node to check against
         ...
         * @param {import("eslint").AST.Node} node The function node to check.
         ...
         * @param {import("eslint").AST.Node} node A BlockStatement node that is inside of a function.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node node to test
         ...
         * @param {import("eslint").AST.Node} node Variable declaration node
         * @returns {import("eslint").AST.Node[]} Filtered elements
         */
