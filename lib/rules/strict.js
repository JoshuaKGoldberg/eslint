 ...
 * statements.
 * @param {import("eslint").AST.Node[]} statements Statements in the program or function body.
 * @returns {import("eslint").AST.Node[]} All of the Use Strict Directives.
 */
 ...
 * @param {import("eslint").AST.Node} node A pattern node to check.
 ...
 * @param {import("eslint").AST.Node[]} params A parameter list to check.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node The directive that should be removed
         ...
         * @param {import("eslint").AST.Node[]} nodes Nodes.
         ...
         * @param {import("eslint").AST.Node} node The function declaration or expression.
         * @param {import("eslint").AST.Node[]} useStrictDirectives The Use Strict Directives of the node.
         * @returns {void}
         */
