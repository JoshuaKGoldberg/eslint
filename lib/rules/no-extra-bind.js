...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A node to report. This is a FunctionExpression or
         ...
         * @param {import("eslint").AST.Node} node A node to add. This node is a FunctionExpression
         ...
         * @param {import("eslint").AST.Node} node A node to remove. This node is a
         ...
         * method.
         * @param {import("eslint").AST.Node} node A node to report. This node is an
