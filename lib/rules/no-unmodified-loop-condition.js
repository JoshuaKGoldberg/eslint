 ...
 * @property {import("eslint").AST.Node} group - BinaryExpression or ConditionalExpression nodes
 ...
 * @returns {import("eslint").AST.Node | null} The function node or null.
 */
 ...
 * @param {eslintScope.Reference[]} modifiers The references to update.
 * @returns {void}
 */
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} root A node to check.
         ...
         * @param {eslintScope.Reference} reference A reference to create.
         ...
         * @param {eslintScope.Variable} variable A variable to report.
         * @returns {void}
         */
