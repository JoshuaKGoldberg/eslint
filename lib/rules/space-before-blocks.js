...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node | Token} node `BlockStatement` node or `{` token of a `SwitchStatement` node.
         ...
         * @param {import("eslint").AST.Node | Token} node The AST node of a BlockStatement.
         ...
         * @param {import("eslint").AST.Node} node The node of a SwitchStatement.
         * @returns {void} undefined.
         */
