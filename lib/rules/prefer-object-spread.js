 ...
 * @param {import("eslint").AST.Node} node The node that the rule warns on
 ...
 * @param {import("eslint").AST.Node} node `CallExpression` node to check.
 ...
 * @param {import("eslint").AST.Node|null} node The node that the rule warns on, i.e. the Object.assign call
