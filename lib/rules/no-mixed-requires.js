...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} initExpression The init node of the VariableDeclarator.
         ...
         * @param {import("eslint").AST.Node} declarations The list of VariableDeclarators.
