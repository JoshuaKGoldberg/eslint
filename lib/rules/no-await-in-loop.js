 ...
 * @param {import("eslint").AST.Node} node A node to check.
 * @param {import("eslint").AST.Node} parent A parent node to check.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} awaitNode An AwaitExpression or ForOfStatement node to validate.
         * @returns {void}
         */
