...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} curNode Current class member node.
         * @param {import("eslint").AST.Node} nextNode Next class member node.
         ...
         * @param {import("eslint").AST.Node} node The class member node to check.
         ...
         * @param {import("eslint").AST.Node} prevNode The previous node to match.
         * @param {import("eslint").AST.Node} nextNode The current node to match.
