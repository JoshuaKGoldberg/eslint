...
module.exports = {
    ...
    create(context) {
         ...
         * @returns {IterableIterator<{type:string,node:import("eslint").AST.Node,loc:SourceLocation}>} The declarations.
         */
         ...
         * @param {import("eslint").AST.Node} node The node of the current scope.
         * @returns {void}
         * @private
         */
