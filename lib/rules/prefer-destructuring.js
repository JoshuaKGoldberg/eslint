...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} reportNode the node to report
         ...
         * @param {import("eslint").AST.Node} node the node to be fixed.
         ...
         * @param {import("eslint").AST.Node} leftNode the left-hand side of the assignment
         * @param {import("eslint").AST.Node} rightNode the right-hand side of the assignment
         * @param {import("eslint").AST.Node} reportNode the node to report the error on
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node the variable declarator to check
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node the AssignmentExpression node
         * @returns {void}
         */
