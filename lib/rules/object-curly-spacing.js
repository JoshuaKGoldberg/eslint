...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node The node to report in the event of an error.
         ...
         * first '}' token.
         * @param {import("eslint").AST.Node} node The node to get. This node is an
         ...
         * @param {import("eslint").AST.Node} node An ObjectExpression or ObjectPattern node to check.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node An ImportDeclaration node to check.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node An ExportNamedDeclaration node to check.
         * @returns {void}
         */
