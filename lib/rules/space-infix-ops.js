...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} left The left node of the main node
         * @param {import("eslint").AST.Node} right The right node of the main node
         ...
         * @param {import("eslint").AST.Node} mainNode The node to report
