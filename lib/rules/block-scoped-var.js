...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Makes a block scope.
         * @param {import("eslint").AST.Node} node A node of a scope.
         * @returns {void}
         */
         ...
         * @param {eslintScope.Reference} reference A reference to report.
         * @param {eslintScope.Definition} definition A definition for which to report reference.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node A node to get variables.
         * @returns {void}
         */
        function checkForVariables(node) {
             ...
             * @param {import("eslint").AST.Node} reference node to examine
