 ...
 * @param {import("eslint").AST.Node} caseWhichFallsThrough SwitchCase node which falls through.
 * @param {import("eslint").AST.Node} subsequentCase The case after caseWhichFallsThrough.
