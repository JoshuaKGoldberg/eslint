 ...
 * @param {import("eslint").AST.Node|null} left A left node to traverse. This is a Pattern or
 *      a Property.
 * @param {import("eslint").AST.Node|null} right A right node to traverse. This is a Pattern or
 *      a Property.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A node to report. This is an Identifier node.
         * @returns {void}
         */
