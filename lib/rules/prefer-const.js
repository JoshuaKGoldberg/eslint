 ...
 * @param {import("eslint").AST.Node} identifier An Identifier node to check.
 ...
 * destructuring.
 * @param {eslintScope.Reference} reference A reference to get.
 * @returns {import("eslint").AST.Node | null} A VariableDeclarator/AssignmentExpression node or
 *      null.
 */
 ...
 * @param {import("eslint").AST.Node} node The ObjectPattern or ArrayPattern node to check.
 ...
 * @param {eslintScope.Variable} variable A variable to get.
 * @param {boolean} ignoreReadBeforeAssign
 *      The value of `ignoreReadBeforeAssign` option.
 * @returns {import("eslint").AST.Node | null}
 ...
 * This is used to detect a mix of reassigned and never reassigned in a
 * destructuring.
 * @param {eslintScope.Variable[]} variables Variables to group by destructuring.
 * @param {boolean} ignoreReadBeforeAssign
 *      The value of `ignoreReadBeforeAssign` option.
 * @returns {Map<import("eslint").AST.Node, import("eslint").AST.Node[]>} Grouped identifier nodes.
 */
 ...
 * @param {import("eslint").AST.Node} node The node to search from.
 * @param {string} type The type field of the parent node.
 * @param {Function} shouldStop A predicate that returns true if the traversal should stop, and false otherwise.
 * @returns {import("eslint").AST.Node} The closest ancestor with the specified type; null if no such ancestor exists.
 */
