 ...
 * @param {import("eslint").AST.Node} node The node on the left side of the expression
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node An AssignmentExpression or BinaryExpression node
