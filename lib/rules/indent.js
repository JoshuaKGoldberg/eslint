...
class TokenInfo {
     ...
     * @param {Token|import("eslint").AST.Node} token a node or token
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node[]} elements List of elements that should be offset
        ...
        function addElementListIndent(elements, startToken, endToken, offset) {
             ...
             * @param {import("eslint").AST.Node} element A node in the `elements` list
         ...
         * @param {import("eslint").AST.Node} node A CallExpression or NewExpression node
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node Unknown Node
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} leafNode The expression node that the token belongs directly.
        ...
        /**
         * Ignores a node
         * @param {import("eslint").AST.Node} node The node to ignore
         * @returns {void}
         */
