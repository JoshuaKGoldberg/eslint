...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node An node to check.
         ...
         * @param {(node: import("eslint").AST.Node) => boolean} match a callback that checks whether or not the node verifies its condition or not.
         * @returns {import("eslint").AST.Node | null} the matching node.
         */
         ...
         * @param {import("eslint").AST.Node} variable The variable to check.
         ...
         * @param {eslintScope.Variable} variable The variable to get.
