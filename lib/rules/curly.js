...
module.exports = {
    ...
    create(context) {
         ...
         *        else
         *            bar();
         * @param {import("eslint").AST.Node} node Node representing the code to check.
         ...
         *     else
         *         bar();
         * @param {import("eslint").AST.Node} node `BlockStatement` body with exactly one statement directly inside. The statement can have its own nested statements.
         ...
         * @param {import("eslint").AST.Node} node The node to report if there's a problem.
         * @param {import("eslint").AST.Node} body The body node to check for blocks.
         ...
         * @param {import("eslint").AST.Node} node The first IfStatement node of the chain.
