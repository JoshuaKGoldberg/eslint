...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node a Program or BlockStatement node
         * @returns {import("eslint").AST.Node[]} the leading sequence of directive nodes in the given node's body
         */
