 ...
 * @param {import("eslint").AST.Node} node A VariableDeclarator node to check.
...
class ConsecutiveRange {
     ...
     * @param {import("eslint").AST.Node | Token} node The node to check.
     ...
     * @param {import("eslint").AST.Node} node The node to merge.
     * @returns {void}
     */
    merge(node) {
        this.endNode = node;
     ...
     * @param {import("eslint").AST.Node|null} node The node to reset, or null.
     * @returns {void}
     */
    reset(node) {
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A statement node to report.
         * @returns {void}
         */
