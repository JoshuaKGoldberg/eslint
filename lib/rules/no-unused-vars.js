...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node[]} nodes The candidate function nodes.
         ...
         * @param {Variable} variable eslint-scope variable object.
         * @returns {import("eslint").AST.Node[]} Function nodes.
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} inner A node which is expected as inside.
         * @param {import("eslint").AST.Node} outer A node which is expected as outside.
         ...
         * @param {import("eslint").AST.Node} node The node itself
         ...
         *   the declaration.
         * @param {eslintScope.Reference} ref A reference to check.
         * @param {import("eslint").AST.Node} prevRhsNode The previous RHS node.
         * @returns {import("eslint").AST.Node | null} The RHS node or null.
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} funcNode A function node to check.
         * @param {import("eslint").AST.Node} rhsNode The RHS node of the previous assignment.
         ...
         * @param {import("eslint").AST.Node} id An Identifier node to check.
         * @param {import("eslint").AST.Node} rhsNode The RHS node of the previous assignment.
