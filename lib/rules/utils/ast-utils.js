...
/** @typedef {import("eslint").Rule.Node} import("eslint").AST.Node */
 ...
 * @param {import("eslint").AST.FunctionDeclaration} node A function node to check.
 ...
 * @param {import("eslint").AST.Node} node A start node to find.
 * @returns {import("eslint").AST.Node | null} A found function node.
 */
 ...
 * - FunctionDeclaration
 * - FunctionExpression
 * @param {import("eslint").AST.Node|null} node A node to check.
 ...
 * @param {import("eslint").AST.Node} node The node to check.
 ...
 * @param {import("eslint").AST.Node} node Expression node.
 ...
 *     let a = {[tag`b`]: 1}     // => null
 *     let a = {[`${b}`]: 1}     // => null
 * @param {import("eslint").AST.Node} node The node to get.
 ...
 * @param {import("eslint").AST.Node} node The node to address.
 * @returns {import("eslint").AST.Node} The `ChainExpression#expression` value if the node is a `ChainExpression` node. Otherwise, the node.
 */
 ...
 * @param {import("eslint").AST.Node} left The Literal node to compare.
 * @param {import("eslint").AST.Node} right The other Literal node to compare.
 ...
 *     a[0] = a[0]
 *     a['b'] = a['b']
 * @param {import("eslint").AST.Node} left The left side of the comparison.
 * @param {import("eslint").AST.Node} right The right side of the comparison.
 ...
 * @param {(token: Token) => boolean} f The function to negate.
 * @returns {(token: Token) => boolean} Negated function.
 */
function negate(f) {
 ...
 * @param {import("eslint").AST.Node} node The node to be checked.
 ...
 * @param {import("eslint").AST.Token | import("estree").Comment} token The token to check.
 ...
 * @param {import("eslint").AST.Node} node The function node to get.
 ...
 * @param {import("eslint").AST.Node} left A node 1 to compare.
 * @param {import("eslint").AST.Node} right A node 2 to compare.
 * @param {SourceCode} sourceCode The ESLint source code object.
 ...
 * @param {import("eslint").AST.Node} left A node to check.
 * @param {import("eslint").AST.Node} right Another node to check.
 ...
 * @param {import("eslint").AST.Node} node The SwitchCase node to get.
 * @param {SourceCode} sourceCode The source code object to get tokens.
 ...
 * @param {import("eslint").AST.Node} node `Identifier` or string `Literal` node in a position
 ...
 * @param {import("eslint").AST.Node} node any `Literal` node
 ...
 * @param {import("eslint").AST.Node} node The branch of main condition which needs to be checked
 ...
 * @param {import("eslint").AST.Node} node An identifier node to check.
 ...
 * @param {import("eslint").AST.Node} node The AST node to check.
 ...
 * @type {(sourceCode: SourceCode, node: import("eslint").AST.Node) => boolean}
 * @param {SourceCode} sourceCode The source code object.
 * @param {import("eslint").AST.Node} node A node at the position where an opening parenthesis or bracket will be inserted.
...
module.exports = {
     ...
     * @param {import("eslint").AST.Node} A node to get.
     * @returns {import("eslint").AST.Node | null} The trailing statement's node.
     */
    getTrailingStatement: esutils.ast.trailingStatement,

    /**
     * Finds the variable by a given name in a given scope and its upper scopes.
     * @param {eslintScope.Scope} initScope A scope to start find.
     ...
     * @param {import("eslint").AST.Node} node A function node to check. It also can be an implicit function, like `StaticBlock`
     ...
     * @param {Pick<import("eslint").AST.Node, 'type'> | Pick<import("estree").LogicalExpression, 'operator' | 'type'>} node node to evaluate
     ...
     * @param {import("eslint").AST.Node|null} node The node to check.
     ...
     * @param {import("eslint").AST.Node} node The node to check.
     * @returns {import("eslint").AST.Node[]} The directives found in the directive prologue.
     */
     ...
     * @param {import("eslint").AST.Node} token The token to check.
     ...
     * @param {SourceCode} sourceCode The source code object
     * @param {import("eslint").AST.Node} node An expression node
     ...
     * @param {import("eslint").AST.Node} node import("eslint").AST.Node to check
     ...
     * @param {import("eslint").AST.Node} node Node to check.
