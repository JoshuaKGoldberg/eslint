...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node The node representing the `await` expression to report
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node A node representing a location where an could be thrown
         ...
         * @param {import("eslint").AST.Node} node A node representing the `await` expression to check
