 ...
 * hierarchy.
 * @param {eslintScope.Scope} scope The scope to traverse.
 ...
 * @param {eslintScope.Variable} variable A variable to check.
 ...
 * @param {import("eslint").AST.Node} node A VariableDeclaration node to check.
 ...
 * @param {import("eslint").AST.Node} node A node to get. This is a `VariableDeclaration` or
 *      an `Identifier`.
 * @returns {import("eslint").AST.Node} A scope node. This is one of `Program`, `BlockStatement`,
 ...
 * @param {import("eslint").AST.Node} scopeNode A scope node to check.
...
function isUsedFromOutsideOf(scopeNode) {
     ...
     * @param {eslintScope.Reference} reference A reference to check.
 ...
 * @param {import("eslint").AST.Node} node The initializer node of VariableDeclarator.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} declarator The VariableDeclarator node to check.
         ...
         * initializer.
         * @param {import("eslint").AST.Node} node A variable declaration node to check.
         ...
         * @param {import("eslint").AST.Node} node A variable declaration node to report.
         * @returns {void}
         */
