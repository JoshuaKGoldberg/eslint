...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node the ImportDeclaration node.
         ...
         * @param {import("eslint").AST.Node} left node that appears before the given `right` node.
         * @param {import("eslint").AST.Node} right node that appears after the given `left` node.
