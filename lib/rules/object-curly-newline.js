 ...
 * @param {import("eslint").AST.Node} node Node under inspection
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A node to check. This is an ObjectExpression, ObjectPattern, ImportDeclaration or ExportNamedDeclaration node.
         * @returns {void}
         */
        function check(node) {
