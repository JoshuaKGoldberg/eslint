 ...
 * @returns {import("eslint").AST.Node} the top binary expression node in parents of a given node.
 */
 ...
 * @param {import("eslint").AST.Node} node The node that will be fixed to a template literal
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node1 The first node
         * @param {import("eslint").AST.Node} node2 The second node
         ...
         * @param {import("eslint").AST.Node} currentNode A node that should be converted to a template literal
         ...
         * @param {import("eslint").AST.Node} node A node that should be converted to a template literal
