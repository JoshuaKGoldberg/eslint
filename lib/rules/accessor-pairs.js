 ...
 * @property {import("eslint").AST.Node[]} getters List of getter nodes.
 * @property {import("eslint").AST.Node[]} setters List of setter nodes.
 */
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node The node to report.
         ...
         * @param {import("eslint").AST.Node[]} nodes Nodes to report.
         * @param {string} messageKind "missingGetter" or "missingSetter".
         * @returns {void}
         * @private
         */
         ...
         * @param {import("eslint").AST.Node[]} nodes The list to check.
         * @returns {void}
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} node `ObjectExpression` node to check.
         * @returns {void}
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} node Property descriptor `ObjectExpression` node to check.
         * @returns {void}
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} node `ClassBody` node to check.
         * @returns {void}
         * @private
         */
