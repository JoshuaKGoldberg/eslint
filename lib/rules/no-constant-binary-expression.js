 ...
 * @param {import("eslint").AST.Node} node The AST node being tested.
 ...
 * @param {Scope} scope Scope in which the expression was found.
 * @param {import("eslint").AST.Node} a One side of the expression
 * @param {import("eslint").AST.Node} b The other side of the expression
 * @param {string} operator The binary expression operator
 * @returns {import("eslint").AST.Node | null} The node which will cause the expression to have a constant result.
 */
