...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} callExpression A CallExpression node which is used to reject a Promise
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node A CallExpression node
