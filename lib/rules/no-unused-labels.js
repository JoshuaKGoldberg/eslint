...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A node to add. This is a LabeledStatement.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node A node to report. This is a LabeledStatement.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node A node to mark. This is a BreakStatement or
         *      ContinueStatement.
         * @returns {void}
         */
