 ...
 * @param {import("eslint").AST.Node} id The Identifier node to check.
 * @param {Scope} scope A `escope.Scope` object to find variable (whichever).
 ...
 * @param {import("eslint").AST.Node} id The Identifier node to get.
 * @returns {import("eslint").AST.Node} The mutation node.
 */
