...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A BlockStatement or SwitchStatement node from which to get the open brace.
         ...
         * @param {import("eslint").AST.Node | Token} node An AST node or token
         ...
         * @param {import("eslint").AST.Node} node The AST node of a BlockStatement.
