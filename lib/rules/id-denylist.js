 ...
 * @param {import("eslint").AST.Node} node `Identifier` node to check.
 ...
 * Examples:
 * const { a : b } = foo;
 * @param {import("eslint").AST.Identifier} node `Identifier` node to check.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node `Identifier` node.
