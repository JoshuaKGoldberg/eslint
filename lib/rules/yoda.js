 ...
 * @param {import("estree").Literal & import("eslint").AST.NodeParentExtension} node Node to normalize.
 * @returns {Pick<import("estree").Literal, 'raw' | 'type' | 'value'>} One of the following options.
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.LogicalExpression} node LogicalExpression node to test.
         ...
         * @param {import("eslint").AST.Node} node The BinaryExpression node
