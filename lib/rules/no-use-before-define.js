 ...
 * @param {import("eslint").AST.Node} node `ClassBody` node to check static initializers.
 * @param {number} location A location to check.
 ...
 * Static initializers are static blocks and initializers of static fields.
 * @param {eslintScope.Scope} scope A scope to check.
...
module.exports = {
    ...
    create(context) {
         ...
         * - allowed by options.
         * @param {eslintScope.Reference} reference The reference
         ...
         * @param {eslintScope.Scope} scope The scope object.
         * @returns {void}
         */
