...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} comment The comment to inspect
         ...
         * @param {import("eslint").AST.Node} comment The comment to remove
         ...
         * @returns {import("eslint").AST.Node[]} An array of string nodes.
         */
         ...
         * @returns {import("eslint").AST.Node[]} An array of template literal nodes.
         */
         ...
         * @returns {import("eslint").AST.Node[]} An array of RegExp literal nodes.
         */
         ...
         * @param {import("eslint").AST.Node[]} arr array of AST nodes
