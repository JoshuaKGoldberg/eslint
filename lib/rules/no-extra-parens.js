...
/**
 * @typedef {Object} BufferedReport
 * @property {() => void} finishReport
 */

/**
 * @typedef {Object} ReportsBuffer
 * @property {ReportsBuffer} [upper]
 * @property {import("eslint").AST.Node[]} inExpressionNodes
 * @property {BufferedReport[]} reports
 */
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} newExpression The NewExpression node to be checked.
         ...
         * @param {import("eslint").AST.Node} node node to evaluate; must be surrounded by parentheses
         ...
         * @param {import("eslint").AST.Node} node The node to evaluate.
        ...
        /**
         * Report the node
         * @param {import("eslint").AST.Node} node node to evaluate
         * @returns {void}
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} node MemberExpression node to evaluate
         ...
         * @param {import("eslint").AST.Node} node The node of class declarations to check.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node The node of spread elements/properties to check.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node The ExpressionStatement.expression or ExportDefaultDeclaration.declaration node
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node First node in the path.
         * @param {import("eslint").AST.Node} ancestor Last node in the path.
         * @returns {import("eslint").AST.Node[]} Path, including both nodes.
         ...
         * @param {import("eslint").AST.Node} node First node in the path.
         * @param {import("eslint").AST.Node} descendant Last node in the path.
         * @returns {import("eslint").AST.Node[]} Path, including both nodes.
         ...
         * @param {import("eslint").AST.Node} node Ancestor of an 'in' expression.
         * @param {import("eslint").AST.Node} child Child of the node, ancestor of the same 'in' expression or the 'in' expression itself.
         ...
         * @param {import("eslint").AST.Node} node Node to remove.
         * @returns {void}
         */
         ...
         * @param {import("eslint").AST.Node} node an AssignmentExpression node.
