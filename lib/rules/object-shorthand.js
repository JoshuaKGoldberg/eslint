...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} property Property AST node
         ...
         * @param {import("eslint").AST.Node} node Any AST node.
         ...
         * @param {import("eslint").AST.Node} node Property AST node
         ...
         * @param {import("eslint").AST.Node} node A `Property` node that has a `FunctionExpression` or `ArrowFunctionExpression` as its value
         ...
         * @param {SourceCodeFixer} fixer The fixer object
         * @param {import("eslint").AST.Node} node A `Property` node that has a `FunctionExpression` as its value
         * @returns {Object} A fix for this node
         */
         ...
         * @param {import("eslint").AST.Node} node The node representing the function.
         * @returns {void}
         */
