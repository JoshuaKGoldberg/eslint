 ...
 * @param {import("eslint").AST.Node} node A node to check. This node type is one of
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A node to set as invalid. This is one of
        ...
        return {
             ...
             * @param {import("eslint").AST.Node} node A target node.
             * @returns {void}
             */
            ThisExpression(node) {
