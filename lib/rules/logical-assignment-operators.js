 ...
 * @param {import("eslint").AST.Node} expression Expression to check
 ...
 * @param {import("eslint").AST.Node} expression Test condition
 * @param {import('eslint-scope').Scope} scope Scope of the expression
 ...
 * @param {import("eslint").AST.Node} expression Condition
 ...
 * @param {import("eslint").AST.Node} expression Test condition
 * @param {import('eslint-scope').Scope} scope Scope of the expression
 * @returns {?{ reference: import("eslint").AST.Node, operator: '??'|'||'|'&&'}} Null if not a known existence
 */
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node Assignment expression
         ...
         * @param {import("eslint").AST.Node} node reference
         ...
         * @param {{ messageId: string, node: import("eslint").AST.Node }} descriptor Report descriptor without fix or suggest
         ...
         * @param {import("eslint").AST.Node} node AssignmentExpression or BinaryExpression
