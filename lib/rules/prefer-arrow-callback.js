 ...
 * @param {import("eslint").AST.Node} node A MetaProperty node to check.
 ...
 * @param {eslintScope.Scope} scope A scope to get.
 ...
 * @param {import("eslint").AST.Node[]} paramsList The list of parameters for a function
