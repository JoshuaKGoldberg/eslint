...
module.exports = {
    ...
    create(context) {
         ...
         * @param {eslintScope.Reference} reference The reference to check.
         ...
         * @param {import("eslint").AST.Node} node The MemberExpression node to check.
         ...
         * foo().
         * @param {import("eslint").AST.Node} node The ExpressionStatement node to check.
         ...
         * @param {eslintScope.Reference} reference The reference to report.
         * @returns {void}
         */
