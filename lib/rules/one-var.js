...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} decl variable declaration Node
         ...
         * @param {import("eslint").AST.Node[]} declarations List of declarations
         ...
         * @param {import("eslint").AST.Node} node The VariableDeclaration node to check
         * @returns {void}
         * @private
         */
