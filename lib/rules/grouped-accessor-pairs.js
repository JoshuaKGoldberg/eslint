...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} formerNode getter/setter node that is defined before `latterNode`.
         * @param {import("eslint").AST.Node} latterNode getter/setter node that is defined after `formerNode`.
         * @returns {void}
         * @private
         */
