 ...
 * @param {import("eslint").AST.Node} node A node to get.
 ...
 * @param {import("eslint").AST.Node} node1 A node to check.
 * @param {import("eslint").AST.Node} node2 A node to check.
 ...
 * @param {import("eslint").AST.Node} node A node to be reported or not.
 * @param {[import("eslint").AST.Node]} previousNodes An array contains previous nodes of the module imported or exported.
 ...
 * @param {[{node: import("eslint").AST.Node, declarationType: string}]} nodes An array contains objects, each object contains a node and a declaration type.
 * @param {string} type Declaration type.
 * @returns {[import("eslint").AST.Node]} An array contains only nodes with declarations types equal to type.
 */
 ...
 * @param {import("eslint").AST.Node} node A node to handle.
 */
