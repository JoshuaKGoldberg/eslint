...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node first node after an opening parenthesis.
         ...
         * @param {import("eslint").AST.Node} node node is inside for loop
         ...
         * @param {import("eslint").AST.Node} node The arrow function node.
         * @returns {void}
         */
