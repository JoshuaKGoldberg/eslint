...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node The binary expression node to report.
         * @param {string} loc Is the error "before" or "after" the comma?
         * @param {import("eslint").AST.Node} otherNode The node at the left or right of `node`
         * @returns {void}
         * @private
         */
         ...
         * @param {import("eslint").AST.Node} node An ArrayExpression or ArrayPattern node.
         * @returns {void}
         */
