 ...
 * @param {import("eslint").AST.Node} node A node which can be a BinaryExpression or a LogicalExpression node.
 * This parent node can be BinaryExpression, LogicalExpression
 *      , or a ConditionalExpression node
 * @returns {import("eslint").AST.Node} node the appropriate node(left or test).
 */
...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node A node to check. This is a BinaryExpression
