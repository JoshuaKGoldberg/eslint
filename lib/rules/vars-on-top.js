...
module.exports = {
    ...
    create(context) {
         ...
         * @param {import("eslint").AST.Node} node any node
         ...
         * @param {import("eslint").AST.Node[]} statements collection of ASTNodes for the parent node block
         ...
         * @param {import("eslint").AST.Node} node The node to check
         * @param {import("eslint").AST.Node} parent Parent of the node
         * @returns {void}
         */
