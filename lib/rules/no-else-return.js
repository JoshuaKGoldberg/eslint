...
module.exports = {
    ...
    create(context) {
         ...
         * @param {eslintScope.Scope} scope Function scope or a function's inner scope.
         ...
         * @param {eslintScope.Scope} scope The scope in which the node and the whole 'if' statement is.
