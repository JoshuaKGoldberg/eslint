    ...
    invalid: [
        ...
        },
        {
            ...
            errors: [
                ...
                { messageId: "selfAssignment", data: { name: "b" } },
            ],
        },
        {
            code: "[a, b] = [a, c]",
        ...
        },
        {
            code: "[a, b] = [, b]",
            languageOptions: { ecmaVersion: 6 },
            errors: [{ messageId: "selfAssignment", data: { name: "b" } }],
        },
        {
            code: "[a, ...b] = [a, ...b]",
            languageOptions: { ecmaVersion: 6 },
        ...
        },
        {
            ...
            errors: [
                { messageId: "selfAssignment", data: { name: "b" } },
                { messageId: "selfAssignment", data: { name: "d" } },
            ],
        },
        {
            code: "({a, b} = {a, ...x, b})",
        ...
        // Optional chaining
        {
            ...
            errors: [
                { messageId: "selfAssignment", data: { name: "(a?.b).c" } },
            ],
        },
        {
            code: "a.b = a?.b",
        ...
        // Private members
        {
            ...
            languageOptions: { ecmaVersion: 2022 },
            errors: [
                { messageId: "selfAssignment", data: { name: "this.#field" } },
            ],
        },
        {
            code: "class C { #field; foo() { [this.#field] = [this.#field]; } }",
