...
ruleTester.run("key-spacing", rule, {
    valid: [
        ...
        {
            code: ["({", "    a: 42,", "    get b() { return 42; }", "})"].join(
                "\n",
            ),
            options: [
                {
        ...
        {
            code: ["var obj = {", "    foo: 1, 'bar': 2, baz: 3", "}"].join(
                "\n",
            ),
            options: [
                {
    ...
    invalid: [
        ...
        },
        {
            ...
            errors: [
                {
                    messageId: "missingValue",
                    data: { computed: "computed ", key: "a + b" },
                    type: "Identifier",
                    line: 1,
                    column: 25,
                },
        ...
        },
        {
            ...
            errors: [
                {
                    messageId: "missingValue",
                    data: { computed: "", key: "key1" },
                    type: "Literal",
                },
                {
                    messageId: "missingValue",
                    data: { computed: "", key: "key12" },
                    type: "Literal",
                },
            ],
        },
        ...
        {
            code: ["var obj = {", "    foo: foo", "  , cats: cats", "};"].join(
                "\n",
            ),
            output: [
                "var obj = {",
        ...
        },
        {
            ...
            errors: [
                ...
                {
                    messageId: "extraKey",
                    data: { computed: "", key: "longlonglong" },
                    line: 2,
                    column: 46,
                    type: "Identifier",
                },
