    ...
    invalid: [
        {
            ...
            errors: [
                { messageId: "readonly", data: { name: "mod1" }, column: 25 },
            ],
        },
        {
            code: "import mod2 from 'mod'; mod2 += 0",
            errors: [
                { messageId: "readonly", data: { name: "mod2" }, column: 25 },
            ],
        },
        {
            code: "import mod3 from 'mod'; mod3++",
            errors: [
                { messageId: "readonly", data: { name: "mod3" }, column: 25 },
            ],
        },
        {
            code: "import mod4 from 'mod'; for (mod4 in foo);",
            errors: [
                { messageId: "readonly", data: { name: "mod4" }, column: 25 },
            ],
        },
        {
            code: "import mod5 from 'mod'; for (mod5 of foo);",
            errors: [
                { messageId: "readonly", data: { name: "mod5" }, column: 25 },
            ],
        },
        {
            code: "import mod6 from 'mod'; [mod6] = foo",
            errors: [
                { messageId: "readonly", data: { name: "mod6" }, column: 25 },
            ],
        },
        {
            code: "import mod7 from 'mod'; [mod7 = 0] = foo",
            errors: [
                { messageId: "readonly", data: { name: "mod7" }, column: 25 },
            ],
        },
        {
            code: "import mod8 from 'mod'; [...mod8] = foo",
            errors: [
                { messageId: "readonly", data: { name: "mod8" }, column: 25 },
            ],
        },
        {
            code: "import mod9 from 'mod'; ({ bar: mod9 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "mod9" }, column: 26 },
            ],
        },
        {
            code: "import mod10 from 'mod'; ({ bar: mod10 = 0 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "mod10" }, column: 27 },
            ],
        },
        {
            code: "import mod11 from 'mod'; ({ ...mod11 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "mod11" }, column: 27 },
            ],
        },
        {
            code: "import {named1} from 'mod'; named1 = 0",
            errors: [
                { messageId: "readonly", data: { name: "named1" }, column: 29 },
            ],
        },
        {
            code: "import {named2} from 'mod'; named2 += 0",
            errors: [
                { messageId: "readonly", data: { name: "named2" }, column: 29 },
            ],
        },
        {
            code: "import {named3} from 'mod'; named3++",
            errors: [
                { messageId: "readonly", data: { name: "named3" }, column: 29 },
            ],
        },
        {
            code: "import {named4} from 'mod'; for (named4 in foo);",
            errors: [
                { messageId: "readonly", data: { name: "named4" }, column: 29 },
            ],
        },
        {
            code: "import {named5} from 'mod'; for (named5 of foo);",
            errors: [
                { messageId: "readonly", data: { name: "named5" }, column: 29 },
            ],
        },
        {
            code: "import {named6} from 'mod'; [named6] = foo",
            errors: [
                { messageId: "readonly", data: { name: "named6" }, column: 29 },
            ],
        },
        {
            code: "import {named7} from 'mod'; [named7 = 0] = foo",
            errors: [
                { messageId: "readonly", data: { name: "named7" }, column: 29 },
            ],
        },
        {
            code: "import {named8} from 'mod'; [...named8] = foo",
            errors: [
                { messageId: "readonly", data: { name: "named8" }, column: 29 },
            ],
        },
        {
            code: "import {named9} from 'mod'; ({ bar: named9 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "named9" }, column: 30 },
            ],
        },
        {
        ...
        },
        {
            ...
            errors: [
                { messageId: "readonly", data: { name: "foo" }, column: 37 },
            ],
        },
        {
        ...
        },
        {
            ...
            errors: [
                { messageId: "readonly", data: { name: "mod6" }, column: 30 },
            ],
        },
        {
            code: "import * as mod7 from 'mod'; [mod7 = 0] = foo",
            errors: [
                { messageId: "readonly", data: { name: "mod7" }, column: 30 },
            ],
        },
        {
            code: "import * as mod8 from 'mod'; [...mod8] = foo",
            errors: [
                { messageId: "readonly", data: { name: "mod8" }, column: 30 },
            ],
        },
        {
            code: "import * as mod9 from 'mod'; ({ bar: mod9 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "mod9" }, column: 31 },
            ],
        },
        {
            code: "import * as mod10 from 'mod'; ({ bar: mod10 = 0 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "mod10" }, column: 32 },
            ],
        },
        {
            code: "import * as mod11 from 'mod'; ({ ...mod11 } = foo)",
            errors: [
                { messageId: "readonly", data: { name: "mod11" }, column: 32 },
            ],
        },
        {
