...
ruleTester.run("object-curly-newline", rule, {
    valid: [
        ...
        {
            code: ["var c = {", "    a: 1, b: 2", "};"].join("\n"),
            options: ["always"],
        },
        {
            code: ["var d = {", "    a: 1,", "    b: 2", "};"].join("\n"),
            options: ["always"],
        },
        {
            code: [
        ...
        {
            code: ["function foo({", " a,", " b", "} : MyType) {}"].join("\n"),
            options: ["always"],
            languageOptions: {
                parser: require(
                    resolvePath(
        ...
        {
            code: ["var e = {a: function() { dosomething();}};"].join("\n"),
            options: [{ multiline: true, consistent: true }],
        },
        {
            code: [
        ...
        {
            code: ["let {k = function() {dosomething();}} = obj;"].join("\n"),
            options: [{ multiline: true, consistent: true }],
            languageOptions: { ecmaVersion: 6 },
        },
        {
        ...
        {
            code: ["import {a as a, b} from 'module';"].join("\n"),
            options: [{ ImportDeclaration: "never" }],
        },
        {
            code: ["import { a, } from 'module';"].join("\n"),
        ...
        // "ExportDeclaration" ---------------------------------------------
        {
            code: ["var a = 0, b = 0;", "export {a,", "b};"].join("\n"),
        ...
        {
            code: ["export { a } from 'module';"].join("\n"),
            options: [{ ExportDeclaration: { multiline: true } }],
        },
        {
            code: ["export {", "a, ", "b", "} from 'module';"].join("\n"),
            options: [{ ExportDeclaration: { multiline: true } }],
        },
        {
            code: ["export {a, ", "b} from 'module';"].join("\n"),
    ...
    invalid: [
        ...
        {
            code: "function foo({ a, b } : MyType) {}",
            output: ["function foo({", " a, b ", "} : MyType) {}"].join("\n"),
            options: ["always"],
            languageOptions: {
                parser: require(
                    resolvePath(
        ...
        {
            code: ["var c = {", "    a: 1, b: 2 // comment", "};"].join("\n"),
        ...
        {
            code: ["var d = {a: 1, // comment", "    b: 2};"].join("\n"),
        ...
        {
            code: ["let {e = function() {", "dosomething();", "}} = a;"].join(
                "\n",
            ),
            output: [
                "let {",
        ...
        {
            code: ["import {a as c, b} from 'module';"].join("\n"),
        ...
        {
            code: ["export {a as a, b} from 'module';"].join("\n"),
