...
const ONE_BLANK = "var greet = 'hello';\n\nconsole.log(greet);",
    ...
    ONE_BLANK_WITH_TRAILING_WS =
        "var greet = 'hello';    \n\nconsole.log(greet);",
    ONE_BLANK_WITH_INLINE_COMMENT =
        "var greet = 'hello'; // inline comment\n\nconsole.log(greet);",
    NEXT_LINE_COMMENT_ONE_BLANK =
        "var greet = 'hello';\n// next-line comment\n\nconsole.log(greet);",
    NEXT_LINE_BLOCK_COMMENT_ONE_BLANK =
        "var greet = 'hello';\n/* block comment\nblock comment */\n\nconsole.log(greet);",
    NEXT_LINE_TWO_COMMENTS_ONE_BLANK =
        "var greet = 'hello';\n// next-line comment\n// second-line comment\n\nconsole.log(greet);",
    NEXT_LINE_COMMENT_BLOCK_COMMENT_ONE_BLANK =
        "var greet = 'hello';\n// next-line comment\n/* block comment\nblock comment */\n\nconsole.log(greet);",
    MIXED_COMMENT_ONE_BLANK =
        "var greet = 'hello';\n// inline comment\nvar name = 'world';\n\nconsole.log(greet, name);",
    MIXED_BLOCK_COMMENT_ONE_BLANK =
        "var greet = 'hello';\n/* block comment\nblock comment */\nvar name = 'world';\n\nconsole.log(greet, name);",
    MULTI_VAR_ONE_BLANK =
        "var greet = 'hello';\nvar name = 'world';\n\nconsole.log(greet, name);",
    MULTI_VAR_NO_BREAK_ONE_BLANK =
        "var greet = 'hello';var name = 'world';\n\nconsole.log(greet, name);",
    MULTI_DEC_ONE_BLANK =
        "var greet = 'hello', name = 'world';\n\nconsole.log(greet, name);",
    MULTI_LINE_ONE_BLANK =
        "var greet = 'hello',\nname = 'world';\n\nconsole.log(greet, name);",
    MULTI_LINE_ONE_BLANK_WITH_COMMENTS =
        "var greet = 'hello', // inline comment\nname = 'world'; // inline comment\n\nconsole.log(greet, name);",
    MULTI_LINE_NEXT_LINE_COMMENT_ONE_BLANK =
        "var greet = 'hello',\nname = 'world';\n// next-line comment\n\nconsole.log(greet);",
    MULTI_LINE_NEXT_LINE_BLOCK_COMMENT_ONE_BLANK =
        "var greet = 'hello',\nname = 'world';\n/* block comment\nblock comment */\n\nconsole.log(greet);",
    ...
    MIXED_LET_CONST =
        "let greet = 'hello';\nconst name = 'world';\n\nconsole.log(greet, name);",
    NOT_END_OF_FUNCTION_ONE_BLANK =
        "function example() {\nvar greet = 'hello';\n\nconsole.log(greet);\n}",
    NOT_END_OF_FUNCTION_EXPRESSION_ONE_BLANK =
        "var f = function() {\nvar greet = 'hello';\n\nconsole.log(greet);\n};",
...
const NO_BREAK = "var greet = 'hello';console.log(greet);",
    ...
    NO_BLANK_WITH_INLINE_COMMENT =
        "var greet = 'hello'; // inline comment\nconsole.log(greet);",
    NEXT_LINE_COMMENT =
        "var greet = 'hello';\n// next-line comment\nconsole.log(greet);",
    NEXT_LINE_BLOCK_COMMENT =
        "var greet = 'hello';\n/* block comment\nblock comment */\nconsole.log(greet);",
    NEXT_LINE_TWO_COMMENTS_NO_BLANK =
        "var greet = 'hello';\n// next-line comment\n// second-line comment\nconsole.log(greet);",
    NEXT_LINE_COMMENT_BLOCK_COMMENT_NO_BLANK =
        "var greet = 'hello';\n// next-line comment\n/* block comment\nblock comment */\nconsole.log(greet);",
    MIXED_COMMENT_NO_BLANK =
        "var greet = 'hello';\n// inline comment\nvar name = 'world';\nconsole.log(greet, name);",
    MIXED_BLOCK_COMMENT_NO_BLANK =
        "var greet = 'hello';\n/* block comment\nblock comment */\nvar name = 'world';\nconsole.log(greet, name);",
    MULTI_VAR_NO_BREAK =
    ...
    MULTI_LINE_NO_BLANK =
        "var greet = 'hello',\nname = 'world';\nconsole.log(greet, name);",
    MULTI_LINE_NO_BLANK_WITH_COMMENTS =
        "var greet = 'hello', // inline comment\nname = 'world'; // inline comment\nconsole.log(greet, name);",
    MULTI_LINE_NEXT_LINE_COMMENT =
        "var greet = 'hello',\nname = 'world';\n// next-line comment\nconsole.log(greet);",
    MULTI_LINE_NEXT_LINE_BLOCK_COMMENT =
        "var greet = 'hello',\nname = 'world';\n/* block comment\nblock comment */\nconsole.log(greet);",
    LET_NO_BLANK = "let greet = 'hello';\nconsole.log(greet);",
    CONST_NO_BLANK = "const greet = 'hello';\nconsole.log(greet);",
    NOT_END_OF_FUNCTION =
        "function example() {\nvar greet = 'hello';\nconsole.log(greet);\n}",
    NOT_END_OF_FUNCTION_EXPRESSION =
        "var f = function() {\nvar greet = 'hello';\nconsole.log(greet);\n};",
...
ruleTester.run("newline-after-var", rule, {
    valid: [
        ...
        {
            code: MIXED_CONST_VAR,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
            code: MIXED_LET_CONST,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        ...
        {
            code: FOR_LOOP_WITH_LET,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
            code: FOR_LOOP_WITH_VAR,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
        ...
        {
            code: FOR_IN_LOOP_WITH_LET,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
            code: FOR_IN_LOOP_WITH_VAR,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
        ...
        {
            code: FOR_OF_LOOP_WITH_LET,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
            code: FOR_OF_LOOP_WITH_VAR,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
        },
        {
    ...
    invalid: [
        ...
        {
            code: MULTI_VAR_NO_BREAK,
            output: MULTI_VAR_NO_BREAK_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: MULTI_DEC_NO_BREAK,
            output: MULTI_DEC_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        ...
        {
            code: NO_BLANK_WITH_TRAILING_WS,
            output: ONE_BLANK_WITH_TRAILING_WS,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: NO_BLANK_WITH_INLINE_COMMENT,
            output: ONE_BLANK_WITH_INLINE_COMMENT,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: MULTI_VAR_NO_BLANK,
            output: MULTI_VAR_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: MULTI_DEC_NO_BLANK,
            output: MULTI_DEC_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: MULTI_LINE_NO_BLANK,
            output: MULTI_LINE_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: LET_NO_BLANK,
            output: LET_ONE_BLANK,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
            errors: [ALWAYS_ERROR],
        },
        {
            code: CONST_NO_BLANK,
            output: CONST_ONE_BLANK,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
            errors: [ALWAYS_ERROR],
        },
        {
            code: NOT_END_OF_FUNCTION,
            output: NOT_END_OF_FUNCTION_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: NOT_END_OF_FUNCTION_EXPRESSION,
            output: NOT_END_OF_FUNCTION_EXPRESSION_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: NOT_END_OF_ARROW_FUNCTION,
            output: NOT_END_OF_ARROW_FUNCTION_ONE_BLANK,
            options: ["always"],
            languageOptions: { ecmaVersion: 6 },
            errors: [ALWAYS_ERROR],
        },
        ...
        {
            code: ONE_BLANK_WITH_TRAILING_WS,
            output: NO_BLANK_WITH_TRAILING_WS,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        {
            code: ONE_BLANK_WITH_INLINE_COMMENT,
            output: NO_BLANK_WITH_INLINE_COMMENT,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        {
            code: MULTI_VAR_ONE_BLANK,
            output: MULTI_VAR_NO_BLANK,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        {
            code: MULTI_DEC_ONE_BLANK,
            output: MULTI_DEC_NO_BLANK,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        {
            code: MULTI_LINE_ONE_BLANK,
            output: MULTI_LINE_NO_BLANK,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        {
            code: MULTI_LINE_ONE_BLANK_WITH_COMMENTS,
            output: MULTI_LINE_NO_BLANK_WITH_COMMENTS,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        {
        ...
        {
            code: CONST_ONE_BLANK,
            output: CONST_NO_BLANK,
            options: ["never"],
            languageOptions: { ecmaVersion: 6 },
            errors: [NEVER_ERROR],
        },
        {
            code: ONE_BLANK_BEFORE_CASE,
            output: NO_BLANK_BEFORE_CASE,
            options: ["never"],
            errors: [NEVER_ERROR],
        },
        ...
        {
            code: NEXT_LINE_COMMENT,
            output: NEXT_LINE_COMMENT_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: NEXT_LINE_BLOCK_COMMENT,
            output: NEXT_LINE_BLOCK_COMMENT_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: MULTI_LINE_NEXT_LINE_COMMENT,
            output: MULTI_LINE_NEXT_LINE_COMMENT_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: MULTI_LINE_NEXT_LINE_BLOCK_COMMENT,
            output: MULTI_LINE_NEXT_LINE_BLOCK_COMMENT_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: NEXT_LINE_TWO_COMMENTS_NO_BLANK,
            output: NEXT_LINE_TWO_COMMENTS_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
        {
            code: NEXT_LINE_COMMENT_BLOCK_COMMENT_NO_BLANK,
            output: NEXT_LINE_COMMENT_BLOCK_COMMENT_ONE_BLANK,
            options: ["always"],
            errors: [ALWAYS_ERROR],
        },
