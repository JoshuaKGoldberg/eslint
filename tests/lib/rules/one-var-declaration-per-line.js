...
ruleTester.run("one-var-declaration-per-line", rule, {
    valid: [
        ...
        { code: "var a, b, c,\n\nd = 0;", options: ["initializations"] },
        { code: "var a, b,\nc=0\nd = 0;", options: ["initializations"] },
        { code: "let a, b;", options: ["initializations"], languageOptions: { ecmaVersion: 6 } },
        ...
        { code: "for(let a = 0, b = 0;;){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },
        { code: "for(const a = 0, b = 0;;){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },
        { code: "for(var a in obj){}", options: ["always"] },
        { code: "for(let a in obj){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },
        { code: "for(const a in obj){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },
        { code: "for(var a of arr){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },
        { code: "for(let a of arr){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },
        { code: "for(const a of arr){}", options: ["always"], languageOptions: { ecmaVersion: 6 } },

        { code: "export let a, b;", options: ["initializations"], languageOptions: { ecmaVersion: 6, sourceType: "module" } },
        { code: "export let a,\n b = 0;", options: ["initializations"], languageOptions: { ecmaVersion: 6, sourceType: "module" } }
    ],
