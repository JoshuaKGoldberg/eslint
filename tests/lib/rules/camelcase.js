// eslint-disable-next-line @eslint-community/eslint-comments/disable-enable-pair -- apply to all lines
/* eslint-disable camelcase -- test cases include invalid names */
...
ruleTester.run("camelcase", rule, {
    ...
    invalid: [
        ...
        // Optional chaining.
        {
            ...
            errors: [
                { messageId: "notCamelCase", data: { name: "non_camelcase" } },
            ],
        },
        {
            code: "(obj?.o_k).non_camelcase = 0",
        ...
        // class public/private fields, private methods.
        {
            ...
            languageOptions: { ecmaVersion: 2022 },
            errors: [
                { messageId: "notCamelCase", data: { name: "snake_case" } },
            ],
        },
        {
